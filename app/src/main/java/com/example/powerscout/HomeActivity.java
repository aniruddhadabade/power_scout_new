...
public class HomeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupNavigationDrawer();  // Call the method from BaseActivity
    }
...
//                }
//
//                if(itemId == R.id.navCompleteInfo){
//                    Toast.makeText(HomeActivity.this, "Complete Info Clicked", Toast.LENGTH_SHORT).show();
//                    Intent intent = new Intent(HomeActivity.this, complete_info1.class);
//                    startActivity(intent);
//                }
//
